...
export default function Skyline() {
  return (
    <div className="z-40 w-full h-screen flex flex-col items-center justify-center gap-10 p-6">
      <div className="z-40 text-2xl font-bold">SKYLINE</div>
      <div className="z-40 w-80 text-center">
      ...
      <div className="z-40 flex flex-col items-start justify-start  ">
        <div>E-posta*</div>
